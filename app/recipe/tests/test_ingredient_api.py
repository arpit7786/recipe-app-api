...
class PrivateIngredientsApiTests(TestCase):
    ...
    def test_ingredients_limited_to_user(self):
        ...
        new_user = create_user(email='new_user@example.com',
                               password='newpass123')
        create_ingredient(user=new_user, name='Jaiphal')
        ingredient = create_ingredient(user=self.user, name='Fresh Cream')
    ...
    def test_delete_ingredient(self):
        ...
        ingredient = create_ingredient(self.user, 'Lettuce')
